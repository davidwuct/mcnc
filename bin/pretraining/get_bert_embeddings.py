...
class BertEmbedder:
    def __init__(self,
                 pretrained_weights='google/bert_uncased_L-2_H-128_A-2',
...
class RobertaEmbedder:
    ...
    def get_roberta_embedding(self, raw_text: List[str]) -> torch.tensor:
        inputs = self.tokenizer(raw_text, return_tensors="pt", padding=True, trancation=True)
...
def main():
    ...
    # raw_text = ["This is first element continuing statement",
    #             "second element of the list.",
    #             "Chingda Wu is my name."]
    # roberta_embedding = embedder.get_roberta_embedding(raw_text)
    # print(roberta_embedding.shape)
