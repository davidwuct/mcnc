...
class RGCNLayer(nn.Module):
    def __init__(self, in_feat, out_feat, num_rels, num_bases=20,
        ...
        # weight bases for basis decomposition
    ...
    def basis_message_func(self, edges):
        ...
        msg = dgl_utils.bmm_maybe_select(edges.src['h'], weight, edges.data['rel_type'])
